...
public class GenerateImage1 {
	...
	public static void insertDaySum(Graphics2D graphics, AdsPdNewPushByHourE data) {
		...
		drawCenterText(graphics, ChartDataEnum.DAY_SUM.getX2() + SECONDE_CELL / 4,
				...
				ChartDataEnum.DAY_SUM.getY2(), new Font(data.getArriveCount(), Font.PLAIN, 15), null);
		// 到课率
		drawCenterText(graphics, ChartDataEnum.DAY_SUM.getX2() + SECONDE_CELL / 4 * 2,
				...
				ChartDataEnum.DAY_SUM.getY2(), new Font(data.getArrivePercent(), Font.PLAIN, 15), null);
		...
		drawCenterText(graphics, ChartDataEnum.DAY_SUM.getX1() + SECONDE_CELL,
				...
				ChartDataEnum.DAY_SUM.getY2(), new Font(data.getConvertOrderCount(), Font.PLAIN, 15), null);
		// 转化率
		drawCenterText(graphics, ChartDataEnum.DAY_SUM.getX1() + SECONDE_CELL + (THIRD_CELL / 5),
				...
				ChartDataEnum.DAY_SUM.getY2(), new Font(data.getConvertPercent(), Font.PLAIN, 15), null);
		// 到课转化率
		drawCenterText(graphics, ChartDataEnum.DAY_SUM.getX1() + SECONDE_CELL + (THIRD_CELL / 5) * 2,
				...
				ChartDataEnum.DAY_SUM.getY2(), new Font(data.getArriveConvertPercent(), Font.PLAIN, 15), null);
		// GMV
		drawCenterText(graphics, ChartDataEnum.DAY_SUM.getX1() + SECONDE_CELL + (THIRD_CELL / 5) * 3 + 25,
				...
				ChartDataEnum.DAY_SUM.getY2(), new Font(data.getGmv(), Font.PLAIN, 15), null);
		// 例子价值
		drawCenterText(graphics, ChartDataEnum.DAY_SUM.getX1() + SECONDE_CELL + (THIRD_CELL / 5) * 4,
				...
				ChartDataEnum.DAY_SUM.getY2(), new Font(data.getExampleValue(), Font.PLAIN, 15), null);
		...
		drawCenterText(graphics, ChartDataEnum.DAY_SUM.getX1() + SECONDE_CELL + THIRD_CELL,
				...
				ChartDataEnum.DAY_SUM.getY2(), new Font(data.getMoreThanTen(), Font.PLAIN, 15), null);
		// 听80分占比
	...
	public static void insertLive(Graphics2D graphics, List<AdsPdNewPushByHourE> messageList,
			List<AdsPdNewPushByHourE> liveList) {
