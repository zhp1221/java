...
/**
 * <p>阿里自定义的listener:<a>https://gitee.com/easyexcel/easyexcel/blob/master/easyexcel-test/src/test/java/com/alibaba/easyexcel/test/demo/read/DemoDataListener.java<a/></p>
 * <p>这里的PageReadListener类，每超过100条excel行记录，会清空</p>
 *
 * @author zhanghp
...
//        System.out.println(rowsAll);
        EasyExcel.read(path, DemoData.class, TemplateDataValidatedStrategy.EXTERNAL_ORDER.getReadListener()).sheet().doRead();
    }
}
