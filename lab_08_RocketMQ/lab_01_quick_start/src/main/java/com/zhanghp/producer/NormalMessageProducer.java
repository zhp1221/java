...
//        asyncMessaage();
    ...
    public static void syncMessage() {
        ...
        // 4.创建消息
        // 指定topic，tag，boy等
        Message message = new Message("topic_name", "tag_name", "Hello,RockerMQ - Sync".getBytes(RemotingHelper.DEFAULT_CHARSET));
    ...
    public static void asyncMessaage() {
        ...
        for (int i = 0; i < messageCount; i++) {
            try {
                final int index = i;
                // 指定topic，tag，boy等
                Message message = new Message("topic_name", "tag_name", ("Hello,RockerMQ - Async:" + i).getBytes(RemotingHelper.DEFAULT_CHARSET));
